...
import {
  ...
  kickHandler,
  maintenanceHandler,
  maintenanceBackupHandler,
  maintenanceRestoreHandler,
  moveHandler,
  pairHandler,
  pokeHandler,
  rotateSecretHandler,
...
export const ROUTES: readonly RouteSpec[] = [
  ...
  { method: 'POST', path: '/v1/maintenance/backup', auth: 'hmac', capability: Capability.SERVER_BACKUP, handler: maintenanceBackupHandler },
  { method: 'POST', path: '/v1/maintenance/restore', auth: 'hmac', capability: Capability.SERVER_RESTORE, handler: maintenanceRestoreHandler },
